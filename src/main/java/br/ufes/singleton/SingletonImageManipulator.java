 ...
 * @author Alcebiades
 */
public class SingletonImageManipulator {

    private static SingletonImageManipulator singleton = null;
    ...
    private SingletonImageManipulator() 
    {
    ...
    public BufferedImage setImagemDimensao(String caminhoImg, Integer imgLargura, Integer imgAltura) {
        ...
        try {
            ...
            Logger.getLogger(SingletonImageManipulator.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static SingletonImageManipulator getInstance() {
        if(singleton == null)
            singleton = new SingletonImageManipulator();
        return singleton;
    }
